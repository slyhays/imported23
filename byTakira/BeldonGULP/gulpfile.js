...
function cssmin() {
  ...
  .pipe(cleanCSS())
  .pipe(dest('dist/source-files/beldon-css-min-files/'))
}
...
function cssexp() {
  ...
  .pipe(dest('dist/source-files/beldon-css-files/'))
}
...
function libsexp() {
  ...
  .pipe(concat('libs.js'))
  .pipe(dest('dist/source-files/beldon-js-files/'))
}
...
function buildalljs() {
  return src([
    'assets/beldon-app.js',
    'app/js/demo/beldon-demo.js',
    'app/js/beldon-custom.js',
